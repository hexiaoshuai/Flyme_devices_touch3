...
#-----------------------------------------------------------------------------
board_saved_files := lib/libwebviewchromium.so bin/shutdownanimation 
...
#-----------------------------------------------------------------------------
board_modify_apps := TeleService Keyguard SystemUI Telecom FlymeLauncher MmsService TelephonyProvider Settings DownloadProviderUi
...
override_property += \
    ro.flyme.romer=hxs \
    ro.product.model_romer=Touch3_hxs
